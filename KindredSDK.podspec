Pod::Spec.new do |s|
   ...
   s.source = {
       :git => 'https://github.com/kindred-app/KindredSDK-Pod.git', :tag => s.version
   }
   s.platform = :ios, '11.0'
   ...
   s.resources = ['Assets/**/*']
   s.resource_bundle = {
       'KindredSDKBundle' => 'Frameworks/KindredSDK.xcframework/ios-arm64/**/*.lproj'
   }

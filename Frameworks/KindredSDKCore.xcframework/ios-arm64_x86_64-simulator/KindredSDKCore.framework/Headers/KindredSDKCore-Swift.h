...
SWIFT_CLASS("_TtC14KindredSDKCore20CharityConfiguration")
@interface CharityConfiguration : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull charityId;
@property (nonatomic, readonly) NSInteger charityShare;
- (nonnull instancetype)initWithCharityId:(NSString * _Nonnull)charityId charityShare:(NSInteger)charityShare OBJC_DESIGNATED_INITIALIZER;
